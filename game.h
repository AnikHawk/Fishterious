void game()
{
    ...
    flag=1;
    int htime=0,hflag=0,cflag=0,ctime=0;
    //  printf("GAME %d\n",flag);
    ...
    int x1=10,y1=10,x2=50,y2=30,show=0,show2=0,frm,p=0,q=0,eat=0;
    int mark=0;
    ...
    int octo2x=rand()%500+50, octo2y=rand()%300-500;
    int hposx,hposy,lifeplus=-5;
    int cposx,cposy,cplus=-5;


    int flag_s2=99,enemy2x=(rand()%50-1000), enemy2y=rand()%400;
    double m_s2;
...
//             buby2[i]=bub1[i];
    ...
    while(1)
    {
        ...
        if(frame>=0 && frame<=400) level=1;
        if(frame>450 && frame<=800) level=2;
        if(frame>800 && frame<=1200) level=3;

        if(frame>1200 && frame<=1400) lvl=1;
        if(frame>1400 && frame<=1600) lvl=2;
        if(frame>1600 && frame<=1800) lvl=3;
        if(frame>1800 && frame<=2000) lvl=4;
        if(frame>2000 && frame<=2200) lvl=5;
        ...
        if(p==1) mciSendString("play grow.wav",NULL,0,NULL);
        if(show==1)
        {
            p++;
            mciSendString("play grow.wav",NULL,0,NULL);
            x1+=4;
            x2+=10;
            y1+=4;
            y2+=6;
            if(mouse.x<fishx)
            {
                if(frame%8==0) readimagefile("ff0.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                if(frame%8==1) readimagefile("ff1.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                if(frame%8==2) readimagefile("ff2.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                if(frame%8==3) readimagefile("ff3.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                if(frame%8==4) readimagefile("ff4.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                if(frame%8==5) readimagefile("ff5.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                if(frame%8==6) readimagefile("ff6.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                if(frame%8==7) readimagefile("ff7.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                flip=1;
                delay(150);
            }
            if (mouse.x>fishx)
            {
                if(frame%8==0) readimagefile("f0.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                if(frame%8==1) readimagefile("f1.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                if(frame%8==2) readimagefile("f2.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                if(frame%8==3) readimagefile("f3.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                if(frame%8==4) readimagefile("f4.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                if(frame%8==5) readimagefile("f5.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                if(frame%8==6) readimagefile("f6.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                if(frame%8==7) readimagefile("f7.gif",mouse.x-x1,mouse.y-y1,mouse.x+x2,mouse.y+y2);
                flip=0;
                delay(150);
            }
            if(mouse.x==fishx && flip==1)
        ...
        if(q==1) mciSendString("play grow.wav",NULL,0,NULL);
        if(show2==1)
        {
            q++;
            mciSendString("play grow.wav",NULL,0,NULL);
        ...
        if( growth>=1)
        {
            ...
            if(frame%7==0) readimagefile("ss0.gif",enemy2x + mouse.x/(-6.4),enemy2y-(mouse.y/8),enemy2x+250+ mouse.x/(-6.4),enemy2y+200-(mouse.y/8));
            if(frame%7==1) readimagefile("ss1.gif",enemy2x+ mouse.x/(-6.4),enemy2y-(mouse.y/8),enemy2x+ mouse.x/(-6.4)+250,enemy2y+200-(mouse.y/8));
            if(frame%7==2) readimagefile("ss2.gif",enemy2x+ mouse.x/(-6.4),enemy2y-(mouse.y/8),enemy2x+ mouse.x/(-6.4)+250,enemy2y+200-(mouse.y/8));
            if(frame%7==3) readimagefile("ss3.gif",enemy2x+ mouse.x/(-6.4),enemy2y-(mouse.y/8),enemy2x+ mouse.x/(-6.4)+250,enemy2y+200-(mouse.y/8));
            if(frame%7==4) readimagefile("ss5.gif",enemy2x+ mouse.x/(-6.4),enemy2y-(mouse.y/8),enemy2x+ mouse.x/(-6.4)+250,enemy2y+200-(mouse.y/8));
            if(frame%7==5) readimagefile("ss6.gif",enemy2x+ mouse.x/(-6.4),enemy2y-(mouse.y/8),enemy2x+ mouse.x/(-6.4)+250,enemy2y+200-(mouse.y/8));
            if(frame%7==6) readimagefile("ss7.gif",enemy2x+ mouse.x/(-6.4),enemy2y-(mouse.y/8),enemy2x+ mouse.x/(-6.4)+250,enemy2y+200-(mouse.y/8));
            //if(level==1) enemyx-=20;
            //if(level==2) enemyx-=25;
            ...
            if(flag_s2==99)
            {
                if(level==2) enemy2x+=20;
                if(level==3) enemy2x+=25;
                if(level==4) enemy2x+=30;

            }
            if(enemy2x<=50 && enemy2x>=-20) flag_s2=0;

            if(flag_s2>=0 && enemy2x<mouse.x-100)
            {
                if((-enemy2x+mouse.x)<=100)  m_s2=(double)(enemy2y-mouse.y)/100;
                else m_s2=(double)(enemy2y-mouse.y)/(enemy2x-mouse.x);
                //  cout<<m_s<<endl;
                flag_s2=1;
            }
            if(flag_s2>=0)
            {
                if(level==1) enemy2x+=20;
                if(level==2) enemy2x+=20;
                if(level==3) enemy2x+=25;
                if(level==4) enemy2x+=30;

                if(level==1) enemy2y+=(m_s2*20);
                if(level==2) enemy2y+=(m_s2*20);
                if(level==3) enemy2y+=(m_s2*25);
                if(level==4) enemy2y+=(m_s2*30);
            ...
            if(growth>=0)
            {
                if(fishx>=enemy2x-60+ mouse.x/(-6.4) && fishx<=enemy2x+250+ mouse.x/(-6.4) && fishy>=enemy2y+20-(mouse.y/8) && fishy<=enemy2y+160-(mouse.y/8))
                {
                    PlaySound("biteslow.wav",NULL,SND_ASYNC);
                    delay(1000);
                    // outtextxy(50,50,"OOPS");
        ...
        if(level>=2)
        {
            ...
            readimagefile("mine.gif",octo2x + mouse.x/(-6.4),octo2y-(mouse.y/8),octo2x+80+ mouse.x/(-6.4),octo2y+80-(mouse.y/8));
            ...
            if(growth==0)
            {
                if(fishx>=octo2x-50+ mouse.x/(-6.4) && fishx<=octo2x+85+ mouse.x/(-6.4) && fishy>=octo2y-10-(mouse.y/8) && fishy<=octo2y+75-(mouse.y/8))
                {
            ...
            if(growth==1)
            {
                ...
                if(fishx>=octo2x-75+ mouse.x/(-6.4) && fishx<=octo2x+95+ mouse.x/(-6.4) && fishy>=octo2y-(mouse.y/8)-55 && fishy<=octo2y+95-(mouse.y/8))
                {
        ...
        if(hflag==1)
        {
            ...
            {
                mciSendString("play life.mp3",0,0,0);
                hflag=0;
                c--;
                htime=0;
            ...
            //G2
            else if(growth==1 && fishx>=hposx+ mouse.x/(-6.4)-65 && fishx<=hposx+ mouse.x/(-6.4)+50 && fishy>=hposy-(mouse.y/8)-40 && fishy<=hposy-(mouse.y/8)+40 )
            {
                mciSendString("play life.mp3",0,0,0);
                hflag=0;
                c--;
        ...
        if(frame>=lifeplus && frame<=lifeplus+3)
        {
            cout<<"IN"<<endl;
            readimagefile("lifeplus.gif",fishx-50,fishy-35,fishx+50,fishy);
        ...
        //Chemical
        if( frame%80==0 && frame!=0 && growth==1)
        {
            cflag=1;
            cposx= rand()%550 +50;
            cposy= rand()%400 +50;
        ...
        if(cflag==1)
        {
            if(ctime>=0 && ctime<20)
            {
                readimagefile("ch.gif",cposx+mouse.x/(-6.4),cposy-(mouse.y/8),cposx+50+mouse.x/(-6.4),cposy+75-(mouse.y/8));
                ctime++;
            }

            //G1
            /*
              if(growth==0 && fishx>=cposx+ mouse.x/(-6.4)-35 && fishx<=cposx+ mouse.x/(-6.4)+35 && fishy>=cposy-(mouse.y/8)-30 && fishy<=cposy-(mouse.y/8)+30 )
            {
                cflag=0;
                growth=0;
                show2=1;
            ...
            */
            ...
            //G2
            if(growth==1 && fishx>=cposx+ mouse.x/(-6.4)-65 && fishx<=cposx+ mouse.x/(-6.4)+50 && fishy>=cposy-(mouse.y/8)-40 && fishy<=cposy-(mouse.y/8)+40 )
            {
                mciSendString("play chem.mp3",0,0,0);
                cflag=0;
                growth=0;
                show2=1;
                frm=frame;
